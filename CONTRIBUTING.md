# Contributing to archivaltag

This outlines how to propose a change to archivaltag. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("inbo/archivaltag", fork = TRUE)`.
...
Please note that the archivaltag project is released with a [Contributor
Code of Conduct](https://inbo.github.io/archivaltag/CODE_OF_CONDUCT.md).
