...
## Archival tag data structure

Archival tag data are typically **text files** created by tag manufacturers' specific software.

The content of these files could vary a lot. However, we can find three typical sections:
- metadata
- daylog
- data blocks
